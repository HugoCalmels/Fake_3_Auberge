...
export type LoginAttemptWhereInput = {
  ...
  key?: Prisma.StringFilter<"LoginAttempt"> | string
  count?: Prisma.IntFilter<"LoginAttempt"> | number
  lockedUntil?: Prisma.DateTimeNullableFilter<"LoginAttempt"> | Date | string | null
  firstAttemptAt?: Prisma.DateTimeFilter<"LoginAttempt"> | Date | string
}
...
export type LoginAttemptScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"LoginAttempt"> | string
  count?: Prisma.IntWithAggregatesFilter<"LoginAttempt"> | number
  lockedUntil?: Prisma.DateTimeNullableWithAggregatesFilter<"LoginAttempt"> | Date | string | null
  firstAttemptAt?: Prisma.DateTimeWithAggregatesFilter<"LoginAttempt"> | Date | string
}
...
export type LoginAttemptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "count" | "lockedUntil" | "firstAttemptAt", ExtArgs["result"]["loginAttempt"]>
...
export interface LoginAttemptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const loginAttemptWithKeyOnly = await prisma.loginAttempt.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many LoginAttempts and only return the `key`
   * const loginAttemptWithKeyOnly = await prisma.loginAttempt.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more LoginAttempts and only return the `key`
   * const loginAttemptWithKeyOnly = await prisma.loginAttempt.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface LoginAttemptFieldRefs {
  readonly key: Prisma.FieldRef<"LoginAttempt", 'String'>
  readonly count: Prisma.FieldRef<"LoginAttempt", 'Int'>
  readonly lockedUntil: Prisma.FieldRef<"LoginAttempt", 'DateTime'>
  readonly firstAttemptAt: Prisma.FieldRef<"LoginAttempt", 'DateTime'>
}
