...
type Mode = "upcoming" | "current" | "history";
      ...
      <div className="border-b border-[#ece5d8] px-5 py-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div>
            ...
            <p className="mt-3 text-sm text-[#6c675f]">{viewConfig.subtitle}</p>
          </div>
...
function getViewConfig(mode: Mode) {
  if (mode === "upcoming") {
    return {
      ...
      subtitle: "Préparer les arrivées et ouvrir une réservation pour la gérer.",
    };
  }
  ...
  if (mode === "current") {
    return {
      ...
      subtitle: "Voir les séjours actifs et accéder rapidement à leur détail.",
    };
  }

  return {
    title: "Historique",
    subtitle: "Retrouver un séjour passé ou une réservation annulée.",
  };
}
